...
var PiecewiseVisualMapView = /** @class */function (_super) {
  ...
  PiecewiseVisualMapView.prototype.doRender = function () {
    ...
    var selectMode = visualMapModel.get('selectedMode');
    ...
    zrUtil.each(viewData.viewPieceList, function (item) {
      ...
      this._createItemSymbol(itemGroup, representValue, [0, 0, itemSize[0], itemSize[1]], selectMode);
      if (showLabel) {
        var visualState = this.visualMapModel.getValueState(representValue);
        var itemText = new graphic.Text({
          style: {
  ...
  PiecewiseVisualMapView.prototype._createItemSymbol = function (group, representValue, shapeParam, selectMode) {
